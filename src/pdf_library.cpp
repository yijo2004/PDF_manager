...
void PdfLibrary::ScanFolder()
{
    ...
    try
    {
        ...
        //         for (char& c : aLower) c = static_cast<char>(std::tolower(static_cast<unsigned char>(c)));
        //         for (char& c : bLower) c = static_cast<char>(std::tolower(static_cast<unsigned char>(c)));
